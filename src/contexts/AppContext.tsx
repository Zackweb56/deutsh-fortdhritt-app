...
interface AppState {
  ...
  resources: Resource[];
  currentTab: 'schedule' | 'vocabulary' | 'grammar' | 'lessons' | 'listening' | 'readings' | 'stories' | 'resources';
  isLoaded: boolean;
}

interface AppContextType extends AppState {
  setCurrentTab: (tab: 'schedule' | 'vocabulary' | 'grammar' | 'lessons' | 'listening' | 'readings' | 'stories' | 'resources') => void;
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const setCurrentTab = (tab: 'schedule' | 'vocabulary' | 'grammar' | 'lessons' | 'listening' | 'readings' | 'stories' | 'resources') => {
