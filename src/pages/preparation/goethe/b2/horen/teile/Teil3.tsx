          ...
          {['a', 'b', 'c'].map((opt) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[8px] opacity-60 truncate w-full px-1">{personen[opt]?.split(' ')[0]}</span>
              </button>
            );
          })}
        </div>
      ...
      <div className="bg-[#1a1a1a] border border-white/10 rounded-3xl p-6 shadow-xl relative overflow-hidden">
        <div className="flex items-center gap-4 mb-6">
           ...
           <div className="flex-1">
              ...
              <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Radio-Gespräch • 3 Personen</p>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
           {Object.entries(personen).map(([key, name]: [string, any]) => (
             <div key={key} className="flex items-center gap-3 bg-black/40 p-3 rounded-2xl border border-white/5">
                ...
                <div className="flex flex-col min-w-0">
                   <span className="text-[10px] font-black text-white/30 uppercase tracking-widest">Person {key.toUpperCase()}</span>
