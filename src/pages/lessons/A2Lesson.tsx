...
const A2Lesson: React.FC = () => {
  ...
  const content = (a2Details as any[]).find((l) => l.lessonNumber === num);
    ...
    <div className="container mx-auto px-4 py-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">A2 — الدرس {lesson.number}</h1>
      ...
      <div className="flex justify-between items-center pt-6">
        ...
        <div className="flex gap-2">
          ...
          {num < (a2Lessons?.lessons?.length || 0) && (
            <Link 
              to={`/lessons/a2/${num + 1}`}
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90"
            >
